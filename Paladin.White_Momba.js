...
function LoadConfig() {
	...
	*/
	...
	Scripts.ChestMania = false; // Open chests in configured areas. See sdk/areas.txt
		...
		Config.ChestMania.Act2 = [55, 59]; // List of act 2 areas to open chests in
	...
	Config.UseRejuvHP = 33;  // Drink a rejuvenation potion if life is under designated percent.
	...
	// Chicken settings
	Config.LifeChicken = 8; // Exit game if life is less or equal to designated percent.
	...
	Config.PickitFiles.push("koltonLadder.nip");
